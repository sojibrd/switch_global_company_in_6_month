...
এটা তিনটা বিকল্প plan-এর একটা। একজন একটাই চালায়: [লোকাল](https://github.com/sojibrd/switch_in_6_month_local_company) · [রিমোট](https://github.com/sojibrd/switch_in_6_month_remote_company) · **গ্লোবাল** (এটা)। তিনটার কোড হুবহু এক।

**লাইভ:** https://sojibrd.github.io/switch_in_6_month_global_company/
...
- **System design-ও এই সাইটে নয়।** দিন ০০৮–১৭৫-এর design-এর ঘর [`system_design_global_company`](https://sojibrd.github.io/system_design_global_company/)-এ — কাজ এখান থেকে হুবহু সরানো, ঐ সাইটের দিন = এই plan-এর দিন − ৭; এখানে ঘর আর লিংক, আর plan-এর নিজের mock।
- **Behavioural-ও এই সাইটে নয়।** দিন ০০৬–১৪৩-এর story-র কাজ [`behavioural_interview_global_company`](https://sojibrd.github.io/behavioural_interview_global_company/)-এ — হুবহু সরানো, ঐ সাইটের দিন = এই plan-এর দিন − ৫; এখানে ঘর আর লিংক, রোজের ইংরেজি আর mock।
...
`brainstorming/ASSUMPTIONS.md` → `brainstorming/` (`dsa.md`, `system-design.md`, `which-market.md`, `proof-projects-and-cv.md`, `after-joining.md`, `application-to-offer.md`) → এই ফোল্ডারের `docs/`।
